...
package com.zergclan.wormhole.loader.jdbc;
 ...
 * JDBC loader.
 */
public final class JDBCLoader implements WormholeLoader<DataGroup, LoadResultData> {
    @Override
    ...
    @Override
    public LoadResultData load(final DataGroup data) {
        return null;
    }
